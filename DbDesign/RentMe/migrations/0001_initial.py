# -*- coding: utf-8 -*-
# Generated by Django 1.11.1 on 2017-06-22 05:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('car_reverse_radar', models.CharField(choices=[('Sing', '单天窗'), ('all', '全景天窗'), ('else', '其他'), ('N', '无')], default='无', max_length=4, verbose_name='倒车雷达')),
                ('car_airbag', models.CharField(max_length=2, null=True, verbose_name='气囊')),
                ('car_dvd', models.CharField(choices=[('D', 'DVD'), ('C', 'CD'), ('S', '其他')], default='DVD', max_length=4)),
                ('car_gps', models.CharField(choices=[('Sing', '单天窗'), ('all', '全景天窗'), ('else', '其他'), ('N', '无')], default='无', max_length=5, verbose_name='GPS导航')),
