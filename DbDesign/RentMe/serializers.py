...
class StoreSerializer(serializers.HyperlinkedModelSerializer):
    class Meta:
        model = store_info
        fields = ('store_id','store_addr','store_tel','store_start_time','store_admin','store_record_create_time','record_create_admin','record_delete_status')
#关联 user_info
...
class RentSerializer(serializers.HyperlinkedModelSerializer):
    class Meta:
        model = rent_order
        field = ('order_id','user_num','car_num','user_drive','pick_addr','pick_time','drop_time','actual_deposit','breaken_bill','illegal_info','illegal_bill','actual_money','record_create_admin','order_record_create_time','record_delete_status')
#关联 relet_record
class ReletSerializer(serializers.HyperlinkedModelSerializer):
    class Meta:
        model = relet_record
        field = ('relet_id','order_num','relet_start_time','relet_end_time','record_create_admin','relet_record_create_time','record_delete_status')
#关联 illegal_record
class LllegalSerializer(serializers.HyperlinkedModelSerializer):
    class Meta:
        model = illegal_record
        field = ('illegal_id','illegal_car_num','illegal_date','illegal_bill','illegal_info','illegal_record_create_time','record_create_admin','record_delete_status')
